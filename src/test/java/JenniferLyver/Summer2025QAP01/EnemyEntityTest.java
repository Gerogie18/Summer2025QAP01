...
public class EnemyEntityTest {
    ...
    public void testConstructor_ValidValues() {
        EnemyEntity enemy = new EnemyEntity(1, 100, 10, 1, 10, 10, 100, 1);
    ...
    public void testConstructor_InvalidExperiencePoints() {
        assertThrows(IllegalArgumentException.class, () -> new EnemyEntity(1, 100, 10, 1, 10, 10, -1, 1));
    }

    @Test
    public void testConstructor_InvalidEnemyLevel() {
        assertThrows(IllegalArgumentException.class, () -> new EnemyEntity(1, 100, 10, 1, 10, 10, 100, -1));
    }
